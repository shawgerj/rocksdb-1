...
extern ROCKSDB_LIBRARY_API void rocksdb_set_external(
...
extern ROCKSDB_LIBRARY_API rocksdb_pinnableslice_t* rocksdb_get_external_cf(
...
extern ROCKSDB_LIBRARY_API rocksdb_pinnableslice_t* rocksdb_pget_external_cf(
    rocksdb_t* db, const rocksdb_readoptions_t* options,
    rocksdb_column_family_handle_t* column_family, const char* key,
    size_t keylen, char** errptr);
